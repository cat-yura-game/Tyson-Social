import { ArrowLeft, BadgeCheck, BatteryMedium, BellRing, Camera, ChevronRight, Database, Gem, LockKeyhole, Monitor, Moon, QrCode, RefreshCw, Save, Send, ShieldCheck, Sun, Trash2, Unlink, UserPlus, Volume2 } from 'lucide-react';
