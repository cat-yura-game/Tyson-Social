...
function GuideSteps({ guide }: { guide: IosGuide }) {
  if (guide === 'ios26') return <ol className="ios-pwa-steps"><li><div><b>Нажмите «…»</b><p>Кнопка находится справа в нижней панели Safari.</p></div><img className="ios-pwa-menu-icon" src="/pwa-install-ios-26-step1.jpg" alt="Кнопка с тремя точками" /></li><li><div><b>Выберите «Поделиться»</b></div><img src="/pwa-install-ios-26-step2.jpg" alt="Пункт Поделиться в меню Safari" /></li><li><div><b>Пролистайте меню и нажмите «Добавить на экран „Домой“»</b></div><img src="/pwa-install-ios-26-step3.jpg" alt="Пункт Добавить на экран Домой" /></li></ol>;
  return <ol className="ios-pwa-steps"><li><div><b>Нажмите «Поделиться»</b><p>Откройте меню внизу Safari.</p></div><img className="ios-pwa-share-icon" src="/pwa-install-ios-18-share.jpg" alt="Кнопка Поделиться" /></li><li><div><b>Нажмите «На экран „Домой“»</b><p>При необходимости сначала пролистайте список действий.</p></div><img src="/pwa-install-ios-18-home.jpg" alt="Пункт На экран Домой" /></li></ol>;
}
